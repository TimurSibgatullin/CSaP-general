...
public class RawRow {
    ...
    public boolean badRecord() {
        return riskScoreCVRM.isBlank() || mdrd.isBlank() || glucoseFasting.isBlank() || totalCholesterol.isBlank()
                || systolicBloodPressure.isBlank() || diastolicBloodPressure.isBlank() || bmi.isBlank() || psCVRM.isBlank()
